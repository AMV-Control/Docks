...
1. У одного пользователя может быть несколько портфелей привязанных к платформе
2. Группы портфелей
3. Парсить котировки с Лондонской (Американской) и Московской бирж
4. Группы пользователей: Администратор, обычный пользователь
5. Вход через гугл
6. Расчеты:
  - годовая доходность
  - прирост за месяц
  - диаграммы распределения активов
  - рост по дням (за неделю, месяц, год)
7. Учет замороженных средств
...
2. Криптовалюта как один из активов
3. NFT
4. Web сокеты
5. Маскот
