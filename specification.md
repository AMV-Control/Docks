...
При добавлении ценной бумаги в портфель, необходимо сохранять её цену для дальнейших расчетов.

Должна быть возможность легко изменить количество ценных бумаг в портфеле (прямо в таблице)
...
### <a name="3.10"></a>3.10 Стратегии
У пользователя должна быть возможность создать и легко изменять стратегию.

В стратегии задается какое распределение активов должно быть в портфеле или группе портфелей. При этом должна быть возможность просмотра 
на сколько портфель или группа портфелей отличается от стратегии (число, %).

Стратегия может быть по типу ценных бумаг, по категории и по отраслям.

_Пример:_
![image](https://user-images.githubusercontent.com/56492378/186398695-8a348818-12ac-4a5e-bf44-d365dc57ca44.png)

Одна секция (строка) может включать несколько типов/категорий/отраслей (объединение похожих), при этом они не должны пересекаться.
